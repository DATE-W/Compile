from PyQt5.QtWidgets import QPlainTextEdit, QScrollBar, QWidget, QHBoxLayout, QVBoxLayout,QTextEdit
from PyQt5.QtGui import QFont, QColor, QTextCursor, QSyntaxHighlighter, QTextCharFormat, QTextFormat
...
#         self.current_line_format.setBackground(Qt.yellow)
#
#     def highlightBlock(self, text):
#         cursor = QTextCursor(self.currentBlock())
#         cursor.select(QTextCursor.LineUnderCursor)
#         cursor.mergeCharFormat(self.current_line_format)
